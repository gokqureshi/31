...
function preload() {
   zombie1 = loadImage("./assts/zombie.png");
   zombie2 = loadImage("./assts/zombie.png");

   zombie3 = loadImage("./assts/zombie.png");
   zombie4 = loadImage("./assts/zombie.png");

   backgroundImage = loadImage("./assts/background.png");
}
...
function setup() {
  ...
  matter.Composite.add(bridge.body, jointPonint);
  joint = new jointLink(bridge, jointPonint);
